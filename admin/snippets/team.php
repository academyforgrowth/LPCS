		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/1.jpg" alt="<?php echo $team_member1; ?>" />
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/2.jpg" alt="<?php echo $team_member2; ?>" />
						<div class="team-content">
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/3.jpg" alt="<?php echo $team_member3; ?>" />
						<div class="team-content">
			...
			<div class="row">
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/4.jpg" alt="<?php echo $team_member4; ?>" />		
						<div class="team-content">
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/5.jpg" alt="<?php echo $team_member5; ?>" />
						<div class="team-content">
				...
				<div class="col-sm-4 team-item">
					...
					<figure class="team-wrapper">
						<img src="admin/img/team/6.jpg" alt="<?php echo $team_member6; ?>" />		
						<div class="team-content">
